...
export class Parse5DomAdapter extends DomAdapter {
  ...
  invoke(_el: any /* Element */, _methodName: string, _args: any[]): any {
    ...
    switch (_methodName) {
      case 'createElement': return this.createElement(_args);
      case 'query': return this.query(_args);
      case 'querySelector': return this.querySelector(_el, _args);
      case 'querySelectorAll': return this.querySelectorAll(_el, _args);
      default:
  ...
  querySelector(el: any, selector: any /* string? */): any { return this.querySelectorAll(el, selector)[0]; }
  querySelectorAll(el: any, selector: any /* string? */): any[] {
    const res: any[] = [];
